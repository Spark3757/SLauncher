...
public final class SettingsPage extends SettingsView implements DecoratorPage {
    ...
    public SettingsPage() {
        ...
        ExtendedProperties.selectedItemPropertyFor(cboDownloadSource).bindBidirectional(config().downloadTypeProperty());
        // ====
        ...
        ExtendedProperties.selectedItemPropertyFor(cboLanguage).bindBidirectional(config().localizationProperty());
        // ====
        ...
        ExtendedProperties.reservedSelectedPropertyFor(chkDisableProxy).bindBidirectional(config().hasProxyProperty());
        ...
        ExtendedProperties.selectedItemPropertyFor(proxyConfigurationGroup, Proxy.Type.class).bindBidirectional(config().proxyTypeProperty());
        // ====
        ...
        ExtendedProperties.selectedItemPropertyFor(updateChannelGroup, UpdateChannel.class).bindBidirectional(config().updateChannelProperty());
        // ====
