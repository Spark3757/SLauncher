...
public class ElySession {
    ...
    public ElySession(String clientToken, String accessToken, GameProfile selectedProfile, List<GameProfile> availableProfiles, User user) {
    ...
    public static ElySession fromStorage(Map<?, ?> storage) {
        ...
        return new ElySession(clientToken, accessToken, new GameProfile(uuid, name), null, new User(userId, userProperties));
    }
