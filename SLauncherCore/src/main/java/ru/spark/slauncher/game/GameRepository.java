...
import ru.spark.slauncher.launch.Launcher;
...
public interface GameRepository extends VersionProvider {
     ...
     * Or if it returns a temporary directory, {@link Launcher#makeLaunchScript} will fail.
     * If you do want to return a temporary directory, make {@link Launcher#makeLaunchScript}
